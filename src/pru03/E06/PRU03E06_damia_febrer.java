...
public class PRU03E06_damia_febrer {
	...
	public void menu() {
		...
		do {
			...
			if (menu_principal == 2) {
				// La segona opció del menu ens permet comprar entrades per a la zona que seleccionem, aixo ho fa cridant al mètode vendre que prèviament s'ha definit per la clase Zona
				do {
