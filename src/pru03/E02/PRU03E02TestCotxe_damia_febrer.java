...
public class PRU03E02TestCotxe_damia_febrer extends CotxeAbstracte implements InterfaceCotxe {
	...
	//Aqui definimos el metodo que cambiara de marcha en caso de que el coche sea manual. Tiene un menu que realiza la misma funcion que en el metodo para las marchas automaticas. Para cambiar entre las marchas manuales lo que hace es comprobar que no este ya en esa marcha y ya que queremos que este cambio de marchas sea secuencial tambien comprueba que se encuentre solo 1 marcha por encima o por debajo de la marcha a la que queremos cambiar. Si es asi cambia a la marcha que se le indica. Si no es manual da un error.
	...
	public static void main (String[] args) throws Exception {
		PRU03E02TestCotxe_damia_febrer PIPO = new PRU03E02TestCotxe_damia_febrer("Seat", "Ibiza", TipusCanvi.CanviManual);{
			PIPO.arrancarMotor();
			System.out.println(PIPO.comprovaMotor());
			System.out.println(PIPO.getRevolucions());
			PIPO.CanviarMarxaManual();
			PIPO.aturarMotor();
			System.out.println(PIPO.comprovaMotor());
			System.out.println(PIPO.getRevolucions());
		}
